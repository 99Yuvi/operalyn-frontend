...
import ConversationsList       from '@/pages/shared/ConversationsList'
  ...
  // ── Client ────────────────────────────────────────────────────────────
  {
    ...
    children: [{
      ...
      children: [
        ...
        { path: '/client/chat',                        element: <ConversationsList /> },
        { path: '/client/chat/:conversationId',        element: <ChatView /> },
  ...
  // ── Freelancer ────────────────────────────────────────────────────────
  {
    ...
    children: [{
      ...
      children: [
        ...
        { path: '/freelancer/chat',                         element: <ConversationsList /> },
        { path: '/freelancer/chat/:conversationId',         element: <ChatView /> },
