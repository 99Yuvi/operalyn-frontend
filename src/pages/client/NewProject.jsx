        ...
        {step === 2 && (
          <div className="space-y-5">
            ...
            <div className="flex gap-3 pt-2">
              <button type="button" onClick={() => { set('status', 'draft'); handleSubmit() }} disabled={saving}
